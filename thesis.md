...
EduAttain addresses racial, ethnic, and gender inequalities in education through observing the educated proportions of each population, determining the statistical significance of these identifiers in relation to education, and the subsequent likelihood of achieving a high school diploma or higher. Many of the findings presented in EduAttain echo that of what is already recorded in the literature, while also shedding light on and providing different results related to specific racial and ethnic populations, in order to provide more detailed insight into their rates of educational attainment.
...
add section about fusion analysis serving as the computational theoretical framework for the project
