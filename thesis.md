...
Few studies employ the use of regression to study the effects of different factors on educational attainment. Moreover, of those that do, the focus tends to be on the topic of income and educational attainment [ADD CITATION HERE]. One of the goals of this project is to use a regression model that includes race, Hispanic ethnicity, and gender as they relate to educational attainment. This research shed light on the strength of the relationship between each of the factors. It could also help determine which of these factors plays a bigger role as a determinant of educational attainment.
